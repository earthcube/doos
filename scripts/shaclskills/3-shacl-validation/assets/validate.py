#!/usr/bin/env python
"""
Stage 3 — SHACL validation wrapper (SHACL-for-AI-outputs flow).
...
# defs/shaclValidator.py lives in ../../../shapeValidator/defs/ relative to here.
_SHAPE_VALIDATOR_ROOT = (
    Path(__file__).resolve().parents[3] / "shapeValidator"
)
