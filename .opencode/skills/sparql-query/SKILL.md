...
description: >
  ...
  an endpoint URL. Triggers: SPARQL, Oxigraph, QLever, /query, triplestore,
  schema.org graph, depth assay, variableMeasured, list graphs/types.
...
python .opencode/skills/sparql-query/scripts/sparql_query.py list

# Run a named template
python .opencode/skills/sparql-query/scripts/sparql_query.py run \
...
python .opencode/skills/sparql-query/scripts/sparql_query.py query \
  --endpoint http://localhost:7878/query \
...
python .opencode/skills/sparql-query/scripts/sparql_query.py file \
  --endpoint http://localhost:7878/query \
...
python .opencode/skills/sparql-query/scripts/sparql_query.py --help
```
