...
python skills/DOOS_bundle/doos-bco-dmo-index/assets/run_pipeline.py \
  ...
  --work-dir skills/DOOS_bundle/doos-bco-dmo-index/runs/<timestamp> \
  [--probe] [--limit N]
```
...
Omit `--work-dir` to auto-create `skills/DOOS_bundle/doos-bco-dmo-index/runs/<UTC-timestamp>/`.
...
```bash
python skills/DOOS_bundle/doos-bco-dmo-index/assets/main.py erddap --search depth --output /tmp/inv.json
python skills/DOOS_bundle/doos-bco-dmo-index/assets/main.py iso --input /tmp/inv.json --output /tmp/summary.json
