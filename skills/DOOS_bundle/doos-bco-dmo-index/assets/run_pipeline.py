...
Used by the doos-bco-dmo-index skill. Writes all outputs under a single work directory
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output directory (default: skills/DOOS_bundle/doos-bco-dmo-index/runs/<timestamp>)",
    )
    parser.add_argument(
        "--probe",
        action="store_true",
